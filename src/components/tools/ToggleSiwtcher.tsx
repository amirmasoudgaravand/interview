    ...
    <div className="container">
      <div className="toggle-switch">
        ...
        <label className="label" htmlFor={props.label}>
          <span className={simcardtype !== "credit"? "default_toggle_inner disabled_switch inner" :"inner"} />
          <span className={simcardtype !== "credit"? "default_toggle_switch cursor_disabled switch" :"switch"}  />
        </label>
      </div>
    </div>
  );
